...
public class Badges : IReadmeSection
{
    ...
    /// <inheritdoc />
    public Task<string> Process(IDictionary<string, object?> config, IMarkdownReferences references, IModuleContext context)
    {
        ...
        foreach (var section in _sections)
        {
            ...
            var result = section.Process(subConfig, references, context);
